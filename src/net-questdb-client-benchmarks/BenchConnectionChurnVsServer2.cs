...
public class BenchConnectionChurnVsServer2
{
    private static HttpClient _client;
    private readonly int _httpPort = 9000;
    private readonly int _tcpPort = 9009;

    [Params(5000)] public int BatchSize;

    [Params(1, 4, 16)] public int ConnectionLimit;

    [Params(10)] public int NumberOfTables;

    [Params(100000)] public int RowsPerIteration;

    public BenchConnectionChurnVsServer2()
    {
