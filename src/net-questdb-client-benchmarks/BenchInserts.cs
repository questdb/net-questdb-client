...
public class BenchInserts
{
    ...
    [Params(10000, 100000, 1000000, 10000000)] public int rows_per_iteration;

    [Params(1000, 10000, 25000, 75000, 100000)] public int batch_size;
    ...
    {
        var sender = new Sender($"http::addr=localhost:{HttpPort};auto_flush=on;auto_flush_rows={batch_size};");
