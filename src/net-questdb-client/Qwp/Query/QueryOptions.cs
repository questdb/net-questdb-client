...
public sealed class QueryOptions
{
    ...
    /// <summary>
    ///     Optional path to a PEM or PFX/PKCS#12 bundle pinning custom CA roots. Only self-signed
    ///     certificates in the bundle act as trust anchors; any other certificates only assist
    ///     chain building.
    /// </summary>
